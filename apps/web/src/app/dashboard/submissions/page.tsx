			...
			<div className="db-page-header">
				<div>
					...
					<p className="db-page-sub">
						Review content submitted by creators for your campaigns
					</p>
				</div>
			</div>
			...
			<div className="db-stat-grid-5">
				{stats.map((s) => (
					<div key={s.label} className="db-stat-card">
						<div className="db-stat-label" style={{ marginBottom: 10 }}>
							{s.label}
						</div>
			...
			<div className="db-card">
				<div className="db-empty">
					...
					<div className="db-empty-desc">
						When creators post content for your campaigns, their submissions and
						performance analytics will appear here for review.
					</div>
				</div>
			</div>
